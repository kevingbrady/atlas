...
export default class InformationTypeCatalog extends Component<Props> {
  ...
  render(){
    ...
    let informationTypesViewer = information_types.map((information_type) => {
        ...
        function getCIAStyle(cell, row, rowIndex, colIndex) {
            let cia_background_color = ""
            if ( cell === "high"){
                cia_background_color="#ff9696";

            }
            else if ( cell === "medium"){
                cia_background_color="#ffff91";
            }
            else{
                cia_background_color="#c6ff91";
            }
                            ...
                            <h3>Security Classification</h3>
                             <BootstrapTable
                                ...
                                columns={[
                                    ...
                                    {dataField: "triad_rating.confidentiality", text: 'Confidentiality', editable: false, headerStyle: headerStyle, style: getCIAStyle},
                                    {dataField: "triad_rating.integrity", text: 'Integrity', editable: false, headerStyle: headerStyle, style: getCIAStyle},
                                    {dataField: "triad_rating.availability", text: 'Availability', editable: false, headerStyle: headerStyle, style: getCIAStyle}
                                    ]}
